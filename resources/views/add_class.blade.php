            ...
            <div class="row">
                <div class="col-6">                 
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="class_label" name="class_label">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="select_subject">
                          @foreach ($data as $row)
                          <option value="{{$row->id}}"> {{$row->subject_name." for ".$row->subject_group}} </option>
                          @endforeach                                                                                                                            
                        </select>
                      </div>
