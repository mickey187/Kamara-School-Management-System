                    ...
                    <form action="" method="post"  id="register_form">
                        <ul class="nav nav-tabs " >
                            <li class="nav-item mr-1" id="list_basic_student_info" >
                                <a class="nav-link active_tab1 " style="border: 1px solid #ccc;" id="">Basic Student Information</a>
                            </li>
                            <li class="nav-item mr-1"  id="list_academnic_background">
                                <a class="nav-link  bg-light" style="border: 1px solid #ccc;" id="">Academic Background</a>
                            </li>
                            <li class="nav-item mr-1" id="list_parent_info">
                                <a class="nav-link  bg-light" style="border: 1px solid #ccc;" id="">Parent Information</a>
                            </li>
                            <li class="nav-item mr-1" id="list_address">
                                <a class="nav-link  bg-light" style="border: 1px solid #ccc;" id="">Address</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="address">
                                <div class="card-header bg-light">Address</div>
                                <div class="card-body">
                                    <input type="button" class="btn btn-primary" id="addressPrevious" value="PREVIOUS">
                                </div>
                            </div>
                        </div>
                    </form>
