  ...
  <div class="card-body">
    ...
    <section>
        ...
        <div class="row col-12">
            <div class="col-8">
                <div class="card" style="display: none;" id="class_list">
                ...
                <div class="card" style="display: none;" id="subject_list">
            ...
            <div style="display: none;"  class="col-4" id="subject_group_list">
                <div class="card">
                    <div class="card-header">
                        Assign Subjects
                    </div>
