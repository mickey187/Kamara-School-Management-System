...
<div class="card card-orange">
    <div class="card-header">
      <h3 class="card-title"> <i class="fas fa-tachometer-alt"></i> View Class Label</h3>
  </div>
  <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a name="edit_class_label" id="" class="btn btn-info btn-sm" href="{{ url('editclasslabel/'.$row->id) }}" role="button"> 
                      <i class="fas fa-pencil-alt" aria-hidden="true"></i></a>

                      <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_class_label" data-delete_class_label="{{$row->id}},{{$row->class_label}}">
